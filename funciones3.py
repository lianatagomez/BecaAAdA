...
#                print(t1,MJD_pos[j])
                ...
                if MJD_pos[j] >= t1:
                    ...
                    fila_aux[0, 0] = MJD_pos[j]    # en la primera columna guardamos el t del .fil
                    fila_aux[0, 1] = RA_pos[j]     # en la segunda columna guardamos el RA del .txt
                    fila_aux[0, 2] = DEC_pos[j]    # en la tercera columna guardamos el DEC del .txt
